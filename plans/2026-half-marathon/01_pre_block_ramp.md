...
- Use decision gates before adding meaningful load.
- Keep this bridge as base building only.
...
- Primary standard: keep the training week repeatable enough that the next week still feels available
- Allowed tools: easy running, moderate long run, optional relaxed strides
- Still not included by default: formal SOS structure, hard long-run finishes, or mileage jumps used to compensate for missed days
...
| Day | Run | Purpose | Notes |
| --- | --- | --- | --- |
| Monday | 3-4 mi easy | Easy aerobic / re-entry | Keep this fully conversational. A group run is fine if effort stays controlled. |
| Tuesday | 5-6 mi easy | Easy aerobic | Optional 4-6 x 20 sec relaxed strides only if legs feel good. |
| Wednesday | 4-5 mi very easy | Recovery / easy | Keep this genuinely light. |
| Thursday | 6 mi easy | Easy aerobic | No steady finish. Smooth and uneventful is the goal. |
| Friday | Off | Recovery | No makeup mileage. |
| Saturday | 4-5 mi easy | Easy aerobic | Stay relaxed and economical. |
| Sunday | 9 mi easy | Long run | Finish controlled, not drained. |
...
| Day | Run | Purpose | Notes |
| --- | --- | --- | --- |
| Monday | Off | Recovery | Keep the off day unless the prior week felt trivially easy. |
| Tuesday | 6 mi easy | Easy aerobic | Optional strides only if recovery is clearly good. |
| Wednesday | 5 mi very easy | Recovery / easy | Protect the week by keeping this soft. |
| Thursday | 6 mi easy | Easy aerobic | Conversational throughout. |
| Friday | Off or 3 mi very easy | Recovery / frequency test | Add the short run only if 5 days/week already feels routine, not negotiated. |
| Saturday | 5 mi easy | Easy aerobic | No progression. Just stack the day. |
| Sunday | 9-10 mi easy | Long run | Keep moderate long-run discipline. |
...
| Day | Run | Purpose | Notes |
| --- | --- | --- | --- |
| Monday | Off | Recovery | Stay patient if the weekend created any fatigue carryover. |
| Tuesday | 6 mi easy | Easy aerobic | Optional relaxed strides if legs are responsive. |
| Wednesday | 5 mi very easy | Recovery / easy | Keep this controlled enough to support the weekend. |
| Thursday | 6-7 mi easy | Easy aerobic | No late push. |
| Friday | Off or 3 mi very easy | Recovery / frequency test | Use the 6th day only if the prior two weeks have felt durable. |
| Saturday | 5 mi easy | Easy aerobic | Keep this smooth, not ambitious. |
| Sunday | 10 mi easy | Long run | Finish feeling like one more easy mile would have been possible. |
...
| Day | Run | Purpose | Notes |
| --- | --- | --- | --- |
| Monday | Off | Recovery | Full off is preferred if there is any accumulated fatigue. |
| Tuesday | 5-6 mi easy | Easy aerobic | Keep this fully conversational. |
| Wednesday | 4-5 mi very easy | Recovery / easy | Short and controlled. |
| Thursday | 6 mi easy | Easy aerobic | Smooth, steady, no progression. |
| Friday | Off | Recovery | Drop the 6th-day experiment this week unless freshness is obvious. |
| Saturday | 4-5 mi easy | Easy aerobic | Stay relaxed. |
| Sunday | 9-10 mi easy | Long run | Keep it moderate and finish under control. |

### End-of-Phase 2 Check

Move into Phase 3 as written only if most of the following are true:

- Low-30s mileage now feels normal rather than like a push
- 5 days/week is fully routine
- A 6th day, if used, improved rhythm rather than creating fatigue debt
- Easy days are still easy
- Long runs are not creating multi-day recovery drag
- No recurring warning signs are showing up in calves, Achilles, plantar fascia, knees, hips, or hamstrings

If these are not true, repeat this general load shape before progressing.
...
- Primary standard: enter the block feeling durable and available, not proud of a last-minute mileage spike
- Allowed tools: easy running, moderate long run, optional relaxed strides, and one light quality touch only if clearly tolerated
- Do not do: cram fitness, force 40+ miles/week, or turn the final pre-block weeks into a test
...
| Day | Run | Purpose | Notes |
| --- | --- | --- | --- |
| Monday | Off or 3 mi very easy | Recovery / frequency option | Take the run only if recovery has been clean and routine. |
| Tuesday | 6 mi easy | Easy aerobic | Optional strides if legs feel good. |
| Wednesday | 5 mi very easy | Recovery / easy | Keep this truly light. |
| Thursday | 6-7 mi easy | Easy aerobic | No steady finish. |
| Friday | Off | Recovery | Better slightly underdone than stale. |
| Saturday | 5 mi easy | Easy aerobic | Smooth and relaxed. |
| Sunday | 10-11 mi easy | Long run | Moderate long run only. Finish with control. |
...
| Day | Run | Purpose | Notes |
| --- | --- | --- | --- |
| Monday | Off or 3 mi very easy | Recovery / frequency option | Only add this if the prior week felt routine. |
| Tuesday | 6 mi easy | Easy aerobic | Optional strides if fresh. |
| Wednesday | 5 mi very easy | Recovery / easy | Keep the effort low enough that it helps rather than costs. |
| Thursday | 7 mi easy or light steady finish | Easy aerobic / light quality touch | A short steady finish is optional only if the week has felt easy so far. |
| Friday | Off | Recovery | Do not make up missed mileage here. |
| Saturday | 5-6 mi easy | Easy aerobic | Stay controlled. |
| Sunday | 11 mi easy | Long run | Finish feeling durable, not depleted. |
...
Start the August 3 half-marathon block as written only if most of the following are true:

- Weekly mileage is consistently landing in the 30-35 range
- 5 days/week is automatic and a 6th day is at least plausible if needed
- Easy running still feels easy
- Long runs are controlled rather than draining
- No recurring warning signs are building
- The runner feels slightly hungry for structure, not already worn down

If these are not true, adjust the first 1-2 weeks of the block downward rather than pretending readiness is higher than it is.
